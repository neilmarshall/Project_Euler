...
def main():
    """Return the greatest product of four adjacent numbers in the same
       direction (up, down, left, right, or diagonally) in the 20×20 grid below"""
...
class TestMain(unittest.TestCase):
    def test_main(self):
        self.assertEqual(main(), 70600674)
